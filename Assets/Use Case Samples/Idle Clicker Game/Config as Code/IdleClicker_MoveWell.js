...
module.exports = async ({ params, context, logger }) => {
  try {
    ...
    if (!instance.state) {
//todo1      throw new StateMissingError("MoveWell script executed without valid state setup. Be sure to call GetUpdatedState script before moving wells.");
instance.state = //todo1
{
  unlockCounters: {
    Well_Level1: 10,
    Well_Level2: 10,
