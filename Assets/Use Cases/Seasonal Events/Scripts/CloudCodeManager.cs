    ...
    public class CloudCodeManager : MonoBehaviour
    {
        ...
        public async Task CallGrantEventRewardEndpoint()
        {
            try
            {
                ...
                // called, and a struct for any arguments that need to be passed to the script. In our case we didn't
                // need to pass any additional arguments, so we're passing an empty struct, alternatively you could pass
